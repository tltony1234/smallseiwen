...
class KeywordMappingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword_mapping" do
    assert_difference('KeywordMapping.count') do
      post keyword_mappings_url, params: { keyword_mapping: { channel_id: @keyword_mapping.channel_id, keyword: @keyword_mapping.keyword, messgae: @keyword_mapping.messgae } }
    end
  ...
  test "should update keyword_mapping" do
    patch keyword_mapping_url(@keyword_mapping), params: { keyword_mapping: { channel_id: @keyword_mapping.channel_id, keyword: @keyword_mapping.keyword, messgae: @keyword_mapping.messgae } }
